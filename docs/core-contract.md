...
Status: approved behavior authority. Stages 1-9 and subsequent calendar/birthday/form UI amendments are integrated in the released baseline through Delta 1.0.9. The focused 1.0.10 recovery/persistence hotfix requires existing CI on its exact candidate before merge. `docs/stage9-review.md` preserves historical integrated evidence; `docs/v1.0.10-review.md` records this hotfix. Synthetic host checks are not live SillyTavern/Gemini/provider acceptance.
