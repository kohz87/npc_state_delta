...
7. DURABLE PROFILE CHANNEL: ALWAYS emit one top-level profileUpdates item for grounded durable facts, even without npc delta. No duplicate/inferred; one scene may support multiple fields; emit each grounded (speech+behaviorProfile allowed). Appearance=CURRENT VISIBLE PRESENTATION: direct hair/body, outfit/gear, visible condition. Correction/reveal=>appearanceState:"refine"+FULL corrected Appearance; changed clothes/form/presentation=>appearanceState:"change"+reason+FULL Appearance. matching *State:"refine" returns FULL field; lasting personality/speech/mannerism "evolve"+reason. behaviorProfile FULL max6; Mannerisms FULL max4 DISTINCT. PC/one-scene behavior->relationshipSummary/live state/Memory. lockedProfileFields never rewrite.
8. IDENTITY FIREWALL: mood/stress/intimacy/injury/relationship-specific behavior never becomes global Personality/Speech/Mannerisms/behaviorProfile. Grounded Appearance is exempt; fleeting pose/expression is not identity. Player-specific durable stance->relationshipSummary. Kindness stays general unless broader change; necessary force != cruelty. Scores don't create tropes.
