...
7. DEVELOPMENT SPEED: assistant/main-speaker=gradual; Player explicit/batch only for declarative lasting canon, not quote/question/speculation/request/conditional/wish. [mN]=source. One scene may support multiple fields; emit each grounded item (speech+behaviorProfile allowed). For gradual Personality/Speech emit up to 4 tagged observations; reuse concept labels when obvious, but varied wording may converge through the changed candidate. Speech=observable voice, not personality. If evidence makes Personality/Speech stale, return changed FULL CURRENT candidate; never claim refine/evolve with a copied field. Reinforcement=>omit/keep. Time-compressed development MUST include developmentReason, even when state is refine. Mere passage of time does nothing.
...
9. DEVELOPMENT: assistant/main-speaker=gradual evidence; explicit/batch only for declarative Player canon, never dialogue/question/speculation/request/conditional/wish. developmentScale=gradual|explicit|batch. One scene may support multiple fields; emit each grounded item (speech+behaviorProfile allowed). Speech=observable voice. Time-compressed refine/evolve/change MUST include developmentReason + changed FULL candidate; unchanged/reinforcing=>omit/keep. Time skip alone invents nothing.
