...
7. DURABLE PROFILE CHANNEL: ALWAYS emit profileUpdates for grounded durable facts; npc delta not required. One scene may support multiple fields; emit each grounded (speech+behaviorProfile allowed). Appearance=CURRENT VISIBLE PRESENTATION: hair/body, outfit/gear, condition. EXISTING + grounded visual evidence=>MUST emit appearance+evidence.appearance in profileUpdates, even with other fields. Correction/reveal=>appearanceState:"refine"+FULL Appearance; clothes/form/presentation change=>appearanceState:"change"+reason+FULL Appearance. matching *State:"refine"=>FULL; personality/speech/mannerism "evolve"+reason. behaviorProfile FULL max6; Mannerisms FULL max4. One-scene behavior->relationshipSummary/live/Memory. Locks never rewrite.
