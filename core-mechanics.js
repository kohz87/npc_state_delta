...
7. DEVELOPMENT SPEED: assistant/main-speaker=gradual. Player explicit/batch only for declarative lasting canon, not quote/question/speculation/request/conditional/wish. [mN] tags identify source messages. One scene may support multiple fields. For gradual Personality/Speech, emit up to 4 independent observations with tags; reuse a concept label when obvious, but wording may vary because Delta can converge through the changed candidate. Speech evidence/candidate=observable voice, not personality. If evidence makes Personality/Speech stale, return changed FULL CURRENT candidate; never refine/evolve with a copied field. Reinforcement=>omit/keep. explicit=user lasting change; batch=user elapsed+sustained change. Time-compressed change requires developmentReason. Time alone does nothing.
...
9. DEVELOPMENT SPEED: assistant/main-speaker=gradual. Player explicit/batch only for declarative lasting canon, not quote/question/speculation/request/conditional/wish. batch=elapsed+sustained. Speech evidence/candidate=observable voice, not personality. Time-compressed change requires developmentReason + changed FULL candidate; unchanged/reinforcing=>omit/keep. Time alone invents nothing.
